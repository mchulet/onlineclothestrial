<?php
    ...
    $data_item_as_per_model_results="";
    $image_id = $_POST['selected_image_id'];

//    echo 'SELECT * FROM items WHERE model_id = '.$image_id;exit;
    $sql =	mysql_query("SELECT * FROM items WHERE model_id = ".$image_id);
